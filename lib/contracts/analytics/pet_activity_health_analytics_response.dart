...
class PetActivityHealthAnalyticsResponse {
  ...
  PetActivityHealthAnalyticsResponse({
  ...
  factory PetActivityHealthAnalyticsResponse.fromJson(
    ...
    return PetActivityHealthAnalyticsResponse(
