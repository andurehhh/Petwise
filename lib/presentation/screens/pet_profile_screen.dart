              ...
              SliverAppBar(
                ...
                actions: [
                  IconButton(onPressed:
                      () {/*insert favorite function here*/}, icon: Icon(Icons.favorite_border)),
                  IconButton(
                      onPressed:
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(pet!.name,
                            style: GoogleFonts.plusJakartaSans(color: Colors.black, fontSize: 23, fontWeight: FontWeight.bold, letterSpacing: -1.5)),
                            Text(
                              pet.species,
                              style: GoogleFonts.plusJakartaSans(color: Colors.grey, fontSize: 16, letterSpacing: -1.5),),
                            Text(
                              "${pet.age} years old",
                              style: GoogleFonts.plusJakartaSans(color: Colors.grey, fontSize: 16, letterSpacing: -1.5 ),),
