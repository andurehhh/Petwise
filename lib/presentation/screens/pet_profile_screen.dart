...
class _PetProfileScreenState extends State<PetProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final avatarRadius = (screenWidth * 0.30).clamp(90.0, 120.0);
    final avatarTop = topPad + 64.0;
    final coloredHeight = avatarTop + avatarRadius * 2 + 16;
    // Sheet starts 50px before the avatar bottom, giving ~60% screen to the sheet
    final avatarBottom = avatarTop + avatarRadius * 2;
    final sheetTop = avatarBottom - 50;

    return Scaffold(
      backgroundColor: const Color(0xFFF8F7F6),
      body: Stack(
        children: [
          // ── Fixed colored header (never scrolls) ──────────────────────
          Positioned(
            top: 0,
            left: 0,
            right: 0,
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: SafeArea(
                      child: GestureDetector(
                        onTap: () => Navigator.pushNamed(context, AppRoute.editPetProfile),
                        child: Container(
                          width: 36, height: 36,
                          decoration: BoxDecoration(
                            color: Colors.white.withValues(alpha: 0.25),
          ...
          // ── Scrollable content starting below header ──────────────────
          Positioned(
            top: sheetTop,
            left: 0,
            right: 0,
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      Container(
                        color: Colors.white,
                        padding: EdgeInsets.fromLTRB(20, 62, 20, 40),
                        child: Column(
                      ...
                      children: [
                            ...
                            TextButton.icon(
                              onPressed: pet?.id != null
                                  ? () => showModalBottomSheet(
                                        ...
                                        builder: (_) =>
                                            AddHealthEventSheet(preselectedPetId: pet!.id),
                                      )
                                  : null,
                              icon: const Icon(Icons.add, size: 16, color: Color(0xFFF7A433)),
                              label: Text('Add',
                                  style: GoogleFonts.plusJakartaSans(
                        ...
                        if (healthEventProvider.isLoading)
                          ...
                          Padding(
                            ...
                            child: Text('No upcoming medical events',
                                style: GoogleFonts.plusJakartaSans(color: Colors.grey)),
                          )
                        else
                          ...petEvents.take(3).map((event) => PetwiseUpcomingMedicalPill(
                                event: event,
                                onTap: () {
                          ...
                          children: [
                            ...
                            TextButton.icon(
                              ...
                              icon: const Icon(Icons.arrow_forward_ios,
                                  size: 12, color: Color(0xFFF7A433)),
                              label: Text('Manage',
                                  style: GoogleFonts.plusJakartaSans(
                                      color: const Color(0xFFF7A433),
                                      fontWeight: FontWeight.w600,
                        ...
                        if (vaccinationProvider.isLoading)
                              ...
                              child: Row(
                                children: [
                                  const Icon(Icons.vaccines_outlined,
                                      color: Color(0xFFF7A433), size: 18),
                                  const SizedBox(width: 8),
                                  Expanded(
                                    child: Text('No vaccinations recorded — tap to add',
                                        style: GoogleFonts.plusJakartaSans(
                                            color: const Color(0xFFF7A433),
                                            fontSize: 12,
                                            fontWeight: FontWeight.w600)),
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  _VaccDot(count: validCount, label: 'Valid', color: Colors.green),
                                  const SizedBox(width: 12),
                                  _VaccDot(count: expiringSoonCount, label: 'Expiring', color: Colors.orange),
                                  const SizedBox(width: 12),
                                  _VaccDot(count: expiredCount, label: 'Expired', color: Colors.redAccent),
                                  const Spacer(),
                                  Text('${vaccinations.length} total',
                                      style: GoogleFonts.plusJakartaSans(
                        ...
                        if (recentActivities.isEmpty)
                          ...
                          ...recentActivities
                              .take(3)
                              .map((a) => PetwisePetActivityLog(activity: a)),
          ...
          // ── Avatar straddling the header / sheet boundary ─────────────
          Positioned(
            top: avatarTop,
            left: 0,
            right: 0,
